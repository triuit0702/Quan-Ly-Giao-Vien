 ...
 * webSocketHandlerRegistry.addHandler(getMessageWebSocketHandler(),
 * MESSAGE_ENDPOINT) .setAllowedOrigins("*"); }
 * 
 * @Bean public WebSocketHandler getMessageWebSocketHandler(){ return new
