...
public class GiangVien {
    ...
    public GiangVien(UUID id, String maGV, String hoTen, LocalDate ngaySinh, Boolean gioiTinh, String noiSinh, String queQuan, String danToc, String hocVi, Integer namNhanHV, String nuocNhanHV, Integer namBoNhiem, String chucVu, String donViCongTac, String diaChi, String dienThoai, String email) {
        this.id = id;
        this.maGV = maGV;
        this.hoTen = hoTen;
